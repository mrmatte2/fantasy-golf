export const TIER_LIMITS = { S: 1, A: 2, B: 2, C: Infinity };
...
export const TIER_META = {
  ...
  B: { label: 'B Tier', range: 'World Ranking 16–40', limit: 'Pick up to 2',  color: 'text-blue-400',    bg: 'bg-blue-400/10 border-blue-400/30' },
